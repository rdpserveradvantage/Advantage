                ...
                <div class="pcoded-inner-content">
                    <div class="main-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select name="atmid" class="form-control">
                                                        <option value="">-- Select ATMID --</option>
                                                        <?php 
                                                            $i = 0;
                                                            $atmidlist= mysqli_query($con,"SELECT id,atmid from sites  ");
        											        while($fetch_data = mysqli_fetch_assoc($atmidlist)){
        											            
        											     ?>
    											        <option value="<?php echo $fetch_data['atmid'] ?>" <?php if($_POST['atmid'] == $fetch_data['atmid']){ echo 'selected'; $i++;  }  ?>>
                        ...
                        <?php
                            ...
                            $atm_sql = "select activity,customer,bank,atmid,atmid2,atmid3,address,city,state,zone,LHO,LHO_Contact_Person,LHO_Contact_Person_No,
                                ...
                                XPNET_RemoteAddress,CONNECTIVITY,Connectivity_Type,Site_data_Received_for_Feasiblity_date from sites where 1 ";
                                
                            if(isset($_POST['atmid']) && $_POST['atmid']!=''){
                                $atmid = $_POST['atmid'];
                                $atm_sql .= "and atmid = '".$atmid."'" ;
                                $sqlappCount .= "and atmid = '".$atmid."'" ;
                            }
                            
                            if(isset($_POST['cust']) && $_POST['cust']!=''){
                                $atm_sql .=  "and customer = '".$_POST['cust']."' ";
                                $sqlappCount .= "and customer = '".$_POST['cust']."' ";
                            }
