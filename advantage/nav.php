...
?>
    ...
    <nav class="pcoded-navbar">
        <div class="pcoded-inner-navbar main-menu" style="height: calc(100% - 115px)">
            ...
            <ul class="pcoded-item pcoded-left-item">
                ...
                <li class="pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        <li <?php if (basename($_SERVER['PHP_SELF'], PATHINFO_BASENAME) == 'index.php') {
                                echo "class='active'";
                            } ?>>
                        ...
                        <li <?php if (basename($_SERVER['PHP_SELF'], PATHINFO_BASENAME) == 'dashboard2.php') {
                                echo "class='active'";
                            } ?>>
