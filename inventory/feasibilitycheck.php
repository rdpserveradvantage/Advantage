                                    ...
                                    <!--<form method="POST" action="./API/feasibilitycheck.php" enctype="multipart/form-data" >-->
                                        ...
                                        <div class="card">
                                            <div class="card-block">
                                              <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                  ...
                                                  <select class="form-control" name="noOfAtm" required>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                  <label>ATMID 1</label>
                                                  <input type="text" id="ATMID1" name="ATMID1" class="form-control" value="<? echo $atmid; ?>" <? if($atmid) { echo 'readonly'; } ?> required />
                                                </div>
                                                <div class="col-sm-4">
                                                  <label>ATMID 2</label>
                                              ...
                                              <div class="row">
                                                <div class="col-sm-12">
                                                  <label>Address</label>
                                                  <input type="text" id="address" name="address" class="form-control" value="<? echo $address; ?>" <? if($atmid) { echo 'readonly'; } ?> required />
                                                </div>
                                              </div>
                                              <div class="row">
                                                <div class="col-sm-3">
                                                  <label>City</label>
                                                  <input type="text" id="city" name="city" class="form-control" value="<? echo $city; ?>" <? if($atmid) { echo 'readonly'; } ?> required />
                                                </div>
                                                <div class="col-sm-3">
                                                  <label>Location</label>
                                                  <input type="text" id="location" name="location" class="form-control" value="<? echo $address; ?>" <? if($atmid) { echo 'readonly'; } ?> required />
                                                </div>
                                                <div class="col-sm-3">
                                                  <label>LHO</label>
                                                  <input type="text" id="LHO" name="LHO" class="form-control" value="<? echo $lho; ?>" <? if($atmid) { echo 'readonly'; } ?> required />
                                                </div>
                                                <div class="col-sm-3">
                                                  <label>State</label>
                                                  <input type="text" id="state" name="state" class="form-control" value="<? echo $state; ?>" <? if($atmid) { echo 'readonly'; } ?> required />
                                                </div>
                                              </div>
                                              <div class="row">
                                                <div class="col-sm-3">
                                                  <label>ATMID 1 Working</label>
                                                ...
                                                <div class="col-sm-3">
                                                  <label>ATMID 2 Working</label>
                                                  <select class="form-control" name="atm2Status">
                                                    <option value="">Select</option>
                                                    <option>Yes</option>
                                                    <option>No</option>
                                                  </select>
                                                ...
                                                <div class="col-sm-3">
                                                  <label>ATMID 3 Working</label>
                                                  <select class="form-control" name="atm3Status">
                                                    <option value="">Select</option>
                                                    <option>Yes</option>
                                                    <option>No</option>
                                                  </select>
...
<div class="row">
 ...
 $(document).ready(function() {
    // Event listener for change in NoOfUps select
