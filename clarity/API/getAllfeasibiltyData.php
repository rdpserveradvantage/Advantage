...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    created_at from feasibilityCheck where status=1";
    ...
    while($sql_result = mysqli_fetch_assoc($sql)){
        ...
        $data[] = ['id'=>$id,'noOfAtm'=>$noOfAtm,'ATMID1'=>$ATMID1,'ATMID2'=>$ATMID2,'ATMID3'=>$ATMID3,'address'=>$address,'city'=>$city,'location'=>$location,'LHO'=>$LHO,'state'=>$state,'atm1Status'=>$atm1Status,'atm2Status'=>$atm2Status,'atm3Status'=>$atm3Status,'operator'=>$operator,'signalStatus'=>$signalStatus,'backroomNetworkRemark'=>$backroomNetworkRemark,'backroomNetworkSnap'=>$backroomNetworkSnap,'AntennaRoutingdetail'=>$AntennaRoutingdetail,'EMLockPassword'=>$EMLockPassword,'EMlockAvailable'=>$EMlockAvailable,'NoOfUps'=>$NoOfUps,'PasswordReceived'=>$PasswordReceived,'Remarks'=>$Remarks,'UPSAvailable'=>$UPSAvailable,'UPSBateryBackup'=>$UPSBateryBackup,'UPSWorking1'=>$UPSWorking1,'UPSWorking2'=>$UPSWorking2,'UPSWorking3'=>$UPSWorking3,'backroomDisturbingMaterial'=>$backroomDisturbingMaterial,'backroomDisturbingMaterialRemark'=>$backroomDisturbingMaterialRemark,'backroomKeyName'=>$backroomKeyName,'backroomKeyNumber'=>$backroomKeyNumber,'backroomKeyStatus'=>$backroomKeyStatus,'earthing'=>$earthing,'earthingVltg'=>$earthingVltg,'frequentPowerCut'=>$frequentPowerCut,'frequentPowerCutFrom'=>$frequentPowerCutFrom,'frequentPowerCutRemark'=>$frequentPowerCutRemark,'frequentPowerCutTo'=>$frequentPowerCutTo,'nearestShopDistance'=>$nearestShopDistance,'nearestShopName'=>$nearestShopName,'nearestShopNumber'=>$nearestShopNumber,'powerFluctuationEN'=>$powerFluctuationEN,'powerFluctuationPE'=>$powerFluctuationPE,'powerFluctuationPN'=>$powerFluctuationPN,'powerSocketAvailability'=>$powerSocketAvailability,'routerAntenaPosition'=>$routerAntenaPosition,'routerAntenaSnap'=>$routerAntenaSnap,'AntennaRoutingSnap'=>$AntennaRoutingSnap,'UPSAvailableSnap'=>$UPSAvailableSnap,'NoOfUpsSnap'=>$NoOfUpsSnap,'upsWorkingSnap'=>$upsWorkingSnap,'powerSocketAvailabilitySnap'=>$powerSocketAvailabilitySnap,'earthingSnap'=>$earthingSnap,'powerFluctuationSnap'=>$powerFluctuationSnap,'remarksSnap'=>$remarksSnap,'created_at'=>$created_at] ; 
