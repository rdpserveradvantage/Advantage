                    ...
                    <div class="main-body">
                        ...
                        <?php
                            ...
                            $atm_sql = "select id,activity,customer,bank,atmid,atmid2,atmid3,address,city,state,zone,LHO,LHO_Contact_Person,LHO_Contact_Person_No,
                                ...
                                XPNET_RemoteAddress,CONNECTIVITY,Connectivity_Type,Site_data_Received_for_Feasiblity_date,isDelegated from sites where 1 ";
                                                ...
                                                while($atm_sql_result = mysqli_fetch_assoc($atm_sql_res)){
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td>
                                                        <?
                                                        if($isDelegated==0){ ?>
                                                            <a href="deletage.php?id=<? echo $id?>&atmid=<? echo $atmid; ?>">Delegate</a>                                                            
                                                        <? }else{ ?>
                                                            Delegated | 
                                                            <a href="deletage.php?id=<? echo $id?>&atmid=<? echo $atmid; ?>&action=redelegate">Re-Delegate</a>
