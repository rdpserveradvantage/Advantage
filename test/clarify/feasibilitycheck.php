                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 atmid2Section" style="display:none;">
                                      ...
                                      <div class="col-sm-4 atmid3Section" style="display:none;">
                        ...
                        <div class="card second_card">
                            <div class="card-block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" name="EMlockAvailable" >
                                            <option value="">Select</option>
                                            <option>Yes</option>
                                            <option>No</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control" name="UPSAvailable" >
                                            <option value="">Select</option>
                                            <option>Yes</option>
                                            <option>No</option>
                                        </select>
