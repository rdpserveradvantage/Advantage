                            ...
                            <div class="page-body">
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        ?>
                                        <h5>Delegate : <span style="color:red; "><? echo $atmid . ' '  ; ?></span>To Engineer</h5>
                                        <hr>
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        $action = $_REQUEST['action'];
                                        ?>
                                        <h5>Delegate : <span style="color:red; "><? echo $atmid . ' '  ; ?></span>To Vendor</h5>
                                        <hr>
                                        <form id="myForm" enctype="multipart/form-data">
                                            <input type="hidden" name="atmid" value="<? echo $atmid ; ?>" />
                                            <input type="hidden" name="siteid" value="<? echo $id ; ?>" />
