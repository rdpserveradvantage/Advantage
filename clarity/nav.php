...
$cpermission = "'" . implode ( "', '", $cpermission )."'";
   ...
   //  echo '<pre>';print_r($permission);echo '</pre>';
    foreach($permission as $key=>$val){
        ...
        $sub_menu_sql = mysqli_query($con,"select * from sub_menu where id='".$val."' and isProject=1");
...
<nav class="pcoded-navbar">
                        ...
                        $menu_sql = mysqli_query($con,"select * from main_menu where id='".$menu_id."' and isProject=1");
                        ...
                        ?>
                            ...
                            <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">                                    
                                        ...
                                        $submenu_sql = mysqli_query($con,"select * from sub_menu where main_menu = '".$menu_id."' and id in ($cpermission) and isProject=1");
...
window.addEventListener('load', () => {
  ...
  setTimeout(() => {
    const divElement = document.querySelector('#pcoded'); 
        divElement.setAttribute('nav-type', 'st5'); 
  }, 1000); 
});
