...
if($contactPersonName){
    ...
    $sql = "insert into lhoContactDetails(contactPersonName,contactPersonNo,contactPersonEmail,status) values('".$contactPersonName."','".$contactPersonNo."','".$contactPersonEmail."',1)";
