...
function saveFormData() {
        ...
        xhr.open('POST', 'process_updateMaterialSentTracking.php'); // Replace 'process_updateMaterialSentTracking.php' with the URL of your server-side script to handle form data
