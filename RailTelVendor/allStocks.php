        ...
        <div class="main-body">
            <div class="page-wrapper">
                <div class="page-body">
                    ...
                    <p style="text-align:right;"><a href="#" data-toggle="modal" data-target="#myModal">All Stocks</a>
                    </p>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" name="atmid" class="form-control"
                                            value="<?= $_REQUEST['atmid']; ?>" placeholder="Enter ATMID ..." />
                                    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <?
                    $allSql = "SELECT material,count(1) as total FROM `vendorinventory` where vendorId=1 and material<>'' group by material";
                    $allSqlQuery = mysqli_query($con, $allSql);
                    $grandTotal = 0;
                    while ($allSqlQueryResult = mysqli_fetch_assoc($allSqlQuery)) {
                        $material = $allSqlQueryResult['material'];
                        ...
                        <div class="col-sm-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <span class="strong font-size-18" style="color:#7d818c;">
                                        <?= $material . ' : '; ?>
                                    </span>
                                    <span style="color:red" class="font-size-18">
                                        <?= $total; ?>
                                    </span>
