                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <select name="lho" id="lho" class="form-control">
                                            ...
                                            while ($lho_sqlResult = mysqli_fetch_assoc($lho_sql)) { ?>
                                                <option <? if($_REQUEST['lho']==$lho_sqlResult['lho']){ echo 'selected'; } ?> >
                                                        <?= $lho_sqlResult['lho']; ?>
                                                        </option>
                                            <? } ?>
                                        </select>
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <select name="state" id="state" class="form-control">
                                            ...
                                            while ($state_sqlResult = mysqli_fetch_assoc($state_sql)) {
                                                ?>
                                                <option <? if($_REQUEST['state']==$state_sqlResult['state']){ echo 'selected'; } ?> >
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <select name="city" id="city" class="form-control">
                                            ...
                                            while ($city_sqlResult = mysqli_fetch_assoc($city_sql)) {
                                                ?>
                                                <option <? if($_REQUEST['city']==$city_sqlResult['city']){ echo 'selected'; } ?> >
                                                        <?= $city_sqlResult['city']; ?>
                                                        </option>
                                            <?
                                            }
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                                    ...
                                    <tbody>
                                        ...
                                        while ($sql_result = mysqli_fetch_assoc($sql)) {
                                            ...
                                            <tr>
                                                ...
                                                <a href="<?= $baseurl . $sql_result['remarksSnap']; ?>"
                            ...
                            if ($start_window > 1) {
                                ...
                                echo "<li><a href='?page=1&&atmid=$atmid&&lho$lho&&state=$state&&city=$city'>First</a></li>";
                                echo '<li><a href="?page=' . ($start_window - 1) . '&&atmid=' . $atmid . '&&lho=' . $lho . '&&state=' . $state . '&&city=' . $city . '">Prev</a></li>';
                            }
                            ...
                            if ($end_window < $total_pages) {
                                ...
                                echo '<li><a href="?page=' . ($end_window + 1) . '&&atmid=' . $atmid . '&&lho=' . $lho . '&&state=' . $state . '&&city=' . $city . '">Next</a></li>';
                                echo '<li><a href="?page=' . $total_pages . '&&atmid=' . $atmid . '&&lho' . $lho . '&&state=' . $state . '&&city=' . $city . '">Last</a></li>';
                            }
                            echo '</ul></div>';
