                            ...
                            <div class="page-body">
                                <div class="card">
                                    <div class="card-block" style="overflow: auto;">
                                        ...
                                        <?
                                        $statement = "select distinct(siteid) as siteid from delegation where engineerId='".$userid."' and isFeasibilityDone=0 and status=1 order by id desc" ; 
                                                    ...
                                                    if ($getAtmInfoSqlResult = mysqli_fetch_assoc($getAtmInfoSql)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="button" class="esd-link btn btn-primary btn-sm waves-effect waves-light" data-siteid="<?php echo $siteid; ?>" data-atmid="<?php echo $atmid; ?>" <? if ($isFeasibiltyDone == 1) { echo 'disabled'; } ?> >
                                                                ...
                                                                if($esd!='0000-00-00 00:00:00'){
                                                                    ?>
                                                                |   
                                                                <button type="button" class="asd-link btn btn-primary btn-sm waves-effect waves-light" data-siteid="<?php echo $siteid; ?>" data-atmid="<?php echo $atmid; ?>" <? if ($isFeasibiltyDone == 1) { echo 'disabled'; } ?>>
