                        ...
                        <div class="card-block">
                            ...
                            if (isset($_POST['service'])) {
                                ...
                                if (mysqli_query($con, $sql)) { ?>
                                    <script>
                                        alert('Updated !');
                                        window.location.href = "allotmenu_perm_bank.php?id=<? echo $userid; ?>&level=<?= $level; ?>";
                                    </script>
                                <?      } else { ?>
                                    <script>
                                        alert('Error ! ');
                                                ...
                                                ?>
                                                    <li>
                                                        ...
                                                        <ul class="showsubmenu">
                                                            ...
                                                            ?>
                                                                <li>
                                                                    <input class="submenu" type="checkbox" data-main_id="<? echo $main_id ?>" name="sub_menu[]" value="<? echo $sub_id; ?>" <? if (in_array($sub_id, $serviceuser_permission)) {
                                                                                                                                                                                                echo 'checked';
                                                                                                                                                                                            } ?>> <? echo $sub_sql_result['sub_menu']; ?>
                                                                </li>
                                                            <? } ?>
                                                        </ul>
                                                    </li>
