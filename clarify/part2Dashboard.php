...
$unreadClass = ($highagingsql_result['isRead'] == 'Unread') ? 'unread' : '';

echo "<tr class='{$unreadClass}'>
<td>{$agingCount}</td>
...
background-color: #ffcccc; /* Light red background for unread rows */
font-size: 14px;
}
...
font-weight: bold; /* Make unread ticket IDs bold */
color: #ff0000; /* Red color for unread ticket IDs */
}
</style>
<?
