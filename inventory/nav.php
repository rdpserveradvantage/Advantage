...
if ($_SESSION['username']) {
    ...
    $user = "select * from inventoryUsers where id=" . $id;
    ...
    foreach ($permission as $key => $val) {
        $sub_menu_sql = mysqli_query($con, "select * from sub_menu where id='" . $val . "' and inventory=1 order by sub_menu asc");
    ...
    <nav class="pcoded-navbar">
        <div class="pcoded-inner-navbar main-menu">
            ...
            <ul class="pcoded-item pcoded-left-item">
                ...
                <li <?php if (basename($_SERVER['REQUEST_URI']) == 'index.php') {
                        echo "class='active'";
                    } ?>>
                    <a href="index.php">
                ...
                foreach ($mainmenu as $menu => $menu_id) {
                    ...
                    $menu_sql = mysqli_query($con, "select * from main_menu where id='" . $menu_id . "' and inventory=1");
                ...
                ?>
                    ...
                    <li class="pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            $submenu_sql = mysqli_query($con, "select * from sub_menu where main_menu = '" . $menu_id . "' and id in ($cpermission) and inventory=1 order by sub_menu asc");
