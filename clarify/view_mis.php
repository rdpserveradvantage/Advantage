                                    ...
                                    <div class="custom_table_content">
                                        <table class="table table-hover table-styling table-xs" style="width:100%;">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr <? if ($aging_day > 3 && $status != 'close') { ?> style="background:#fe5d70c2;color:white;" <? } if ($status == 'close') { ?> style="background:#0ac282;color:white;" <?  } elseif ($status == 'schedule') {  ?> style="background:#6c757d;color:white;" <? } elseif ($status == 'open') {  ?> style="background:white;color:black;" <? }  ?>>
                                                        <!--<td><? echo ++$i; ?></td>-->
