                               ...
                               ?>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                        ...
                                        <a href="#" class="openModalBtn" id="openModalBtn" data-toggle="modal" data-target="#columnSelectionModal">Select Columns</a>
                                    ...
                                    <div class="card-body" style="overflow:auto;">
                                        ...
                                        <table id="data-table" class="table table-hover table-styling" style="width:100%;">
                                            <thead>
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($isFeasibiltyDoneRecord) {
                                                            ...
                                                            if ($isDelegated == 0) {
                                                                ...
                                                                echo '<button class="btn btn-success btn-icon">&#10004;</button> | <a href="delegate.php?id=' . $id . '&atmid=' . $atmid . '&action=redelegate">Redelegate <span style="color:red">⟳</span></a>';
                                                            }
                                                        }
                                                        ?>
                                                    </td>
...
$tableColumns = ['#', 'atmid', 'Delegation', 'Delegated To', 'History', 'Current Status', 'PO Number', 'PO Date', 'activity', 'customer',
 'bank', 'address', 'Latitude', 'Longitude', 'city', 'state', 'zone', 'LHO', 'LHO Contact Person', 'LHO Contact Person No' ,'LHO Contact Person email',
 'LHO Adv Person', 'LHO Adv Contact', 'LHO Adv email', 'Project Coordinator Name', 'Project Coordinator No' ,'Project Coordinator email',
  'Customer SLA', 'Our SLA', 'Vendor', 'Cash Management', 'CRA VENDOR', 'ID on Make', 'Model', 'SiteType', 'PopulationGroup', 
  'XPNET_RemoteAddress', 'CONNECTIVITY', 'Connectivity Type', 'Site data Received for Feasiblity date', 'ESD', 'ASD', 'Created At','Created By'];
...
echo '</ul></div>';
    ...
    <div id="columnSelectionModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="columnSelectionModal" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <span class="close" id="closeModalBtn">&times;</span>
            ...
            <button id="applyColumnsBtn" data-dismiss="modal">Apply</button>
      </div>
...
$(document).ready(function() {
  ...
  $(".history-link").click(function() {
    ...
    <script>
        ...
        // Sample column names
        const columnNames = <?= json_encode($tableColumns) ; ?>
