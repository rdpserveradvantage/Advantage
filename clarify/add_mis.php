        ...
        border: 2px solid red;
            ...
            <div class="row">
                ...
                if($_SESSION['SERVICE_level']!=5){
                    //bank have level 5 and the enginner selection will not be visible to them 
                ...
                <div class="col-sm-3">
                    ...
                    <select class="form-control" name="engineer" id="engineer">
                        ...
                        <?
                        $eng_sql = mysqli_query($con,"select * from vendorUsers where vendorId='".$RailTailVendorID."' and level=3 and user_status=1");
                ...
                <div class="col-sm-3">
                    ...
                    <input type="text" name="call_type" id="call_type" class="form-control" value="Service" readonly required>
                </div>
                <div class="col-sm-3">
                    <label>LHO</label>
                ...
                <hr>
                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    <button type="button" id="saveButton" class="btn btn-primary"> Create Call </button>
                                </div>
                            </div>
                        </form>
                    </div>
