    ...
    <div class="card-block">
        ...
        $i = 1; 
            ...
            <tr>
                <td><?= $i; ?></td>
                <td>
                    <a target="_blank" href="mis_details.php?id=<?= $mis_id; ?>">
                ...
                <td>
                    <?
                    if($attachment){ ?>
                        <a href="<?= $attachment ; ?>" class="btn btn-success" target="_blank">View Attachment 1</a>    
                    <? } ?>
                    </td>
                                    <td>
                    <?
                    if($attachment2){ ?>
                        <a href="<?= $attachment2 ; ?>" class="btn btn-success" target="_blank">View Attachment 2</a>    
                    <? } ?>
                    </td>
