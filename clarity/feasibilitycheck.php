                            ...
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" id="ATMID1" name="ATMID1" class="form-control" value="<? echo $atmid; ?>" <? if ($atmid) {
                                                                                                                                            echo 'readonly';
                                                                                                                                        } ?> /> ATMID1 Snap &nbsp; <input type="file" name="ATMID1Snap" />
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" id="location" name="location" class="form-control" value="<? echo $address; ?>" <? if ($atmid) {
                                                                                                                                                echo 'readonly';
                                                                                                                                            } ?> />
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label>Address</label>
                                        <input type="text" id="address" name="address" class="form-control" value="<? echo $address; ?>" <? if ($atmid) {
                                                                                                                                                echo 'readonly';
                                                                                                                                            } ?> />
                                    </div>
                                </div>
                        ...
                        <div class="card second_card">
                            <div class="card-block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" name="EMlockAvailable" id="emLockAvailableSelect" onchange="toggleEmLockAccess(this)">
                                            <option value="">Select</option>
                                            <option>Yes</option>
                                            <option>No</option>
                                        </select>
                                ...
                                <div id="emLockAccessSection" style="display: none;" class="extra_highlight">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <select class="form-control" name="PasswordReceived" onchange="togglePasswordField(this)">
                                                <option value="">Select</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select>
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.code == 200) {
                    ...
                    console.error(response.error); // Assuming the error message is provided in the response
                    submitButton.disabled = false;
                    loadingIndicator.style.display = "none";
                    alert("An error occurred. Please check for details.");
                }
            },
            error: function(xhr, status, error) {
                console.error(error);
