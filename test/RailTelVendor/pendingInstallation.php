...
$pendingInstallationSql = "SELECT * FROM projectInstallation WHERE vendor='".$RailTailVendorID."' AND isDone = 0";
$pendingInstallationSqlCount = "SELECT count(1) as totalRecords FROM projectInstallation WHERE vendor='".$RailTailVendorID."' AND isDone = 0";
...
<form method="GET" action="">
    ...
    <div class="row">
        <div class="col-sm-3">
            ...
            <select name="vendor" class="form-control">
                ...
                while($vendorSql_result = mysqli_fetch_assoc($vendorSql)){ ?>
                    <option value="<? echo $vendorSql_result['vendor']; ?>" <? if($vendorSql_result['vendor']==$_REQUEST['vendor']){ echo 'selected'; }?>>
        ...
        <div class="col-sm-3">
            <label>ATMID</label>
            <input type="text" name="atmid" placeholder="Filter by Atmid" value="<? echo $_REQUEST['atmid']; ?>" class="form-control">        
        </div>
        <div class="col-sm-3">
            <label>SBIN TICKET ID</label>
            <input type="text" name="ticketid" value="<? echo $_REQUEST['ticketid']; ?>" placeholder="Filter by SBIN Ticket ID" class="form-control">
        </div>
