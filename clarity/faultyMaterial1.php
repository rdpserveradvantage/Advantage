                    ...
                    <div class="card">
                        <div class="card-block">
                            ...
                            <form action="<? $_SERVER['PHP_SELF']; ?>" method="post">
                                <table border="1" class="table table-bordered table-striped table-hover dataTable js-exportable no-footer table-xs">
                                    <tr>
                                        <th>Select</th>
                                        <th>Material Name</th>
                                    ...
                                    $sql = "SELECT id, value, needSerialNumber FROM boq where value<>'' ORDER BY needSerialNumber DESC";
