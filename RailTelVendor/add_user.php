                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-warning" href="allotmenu_perm.php?id=<?= $sql_result['id'];  ?>&level=<?= $level; ?>">Menu Permission</a>
                                                        </td>
                                                        <td>
                                                            <a href="#" class="btn btn-danger" onclick="disable(<? echo $sql_result['id']; ?>)">
                                                                <? echo $makeuser_status;?>
                                                            </a></td>
