...
if ($_SESSION['ADVANTAGE_username']) {
    ...
    foreach ($permission as $key => $val) {
        // echo "select * from sub_menu where id='" . $val . "' and isService=1;" ; 
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
            <a class="sidebar-brand brand-logo" href="<? $_SERVER["DOCUMENT_ROOT"]; ?>/corona/index.php"
                style="color:white;">
                 <img src="http://clarify.advantagesb.com/assets/1601680170_capture.jpg" alt="logo" />
                ...
                <li class="nav-item menu-items">
                    ...
                    <div class="collapse" id="<?= $targetDiv; ?>">
                        <ul class="nav flex-column sub-menu">
                            <?
                            $submenu_sql = mysqli_query($con, "select * from sub_menu where main_menu = '" . $menu_id . "' and id in ($cpermission) and isService=1 order by sub_menu asc");
