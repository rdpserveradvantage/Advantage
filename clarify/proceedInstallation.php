                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <ul class="nav nav-tabs md-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#verification" role="tab" aria-selected="false"><i class="icofont icofont-home"></i>Security seal Verification</a>
                                    <div class="slide"></div>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#home7" role="tab" aria-selected="false" <? if($isVerify != 1){ echo 'disabled' ; } ?>  ><i class="icofont icofont-home"></i>Installation Process</a>
                                    <div class="slide"></div>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#holdReason" role="tab" aria-selected="false"><i class="icofont icofont-ui-user"></i>Hold Reason</a>
                                    <div class="slide"></div>
                                </li>
                            </ul>
...
<h3>Approval Status : <? echo $isVerifyRemark ; ?> </h3>

<hr />

        <form id="sealVerification" enctype="multipart/form-data">
            <input type="hidden" name="siteid" value="<? echo $siteid; ?>">
            <input type="hidden" name="atmid" value="<? echo $atmid; ?>">
                
            <div class="col-sm-12">
                <h5 style="color:red;">Upload Security seal no. Image (can also select multiple images )</h5>
      ...
      $('#submitSealverification').click(function(e) {
        ...
        $.ajax({
          ...
          success: function(response) {
              ...
              if(response==200){
                  swal('success','Images Added For Verification', 'success')
                  setTimeout(function () {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4) {
                ...
                if (xhr.status === 200) {
                    ...
                    swal("error", "Error In Record Creation !", "error");
                }
            }
        };
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4) {
            ...
            if (xhr.status === 200) {
                ...
                if (response==200) {
                    swal("Success", "Response Stored Successfully!", "success");
                    setTimeout(function () {
