...
$base_url = "http://clarify.advantagesb.com/corona/";
...
if ($userid > 0) {
    ...
    $assign_cust_sql = mysqli_query($con, "select cust_id,servicePermission from user where userid ='" . $userid . "'");
    ...
    $menuPermission = $assign_cust_sql_result['servicePermission'];
