                        ...
                        <div class="page-wrapper">
                            <div class="page-body">
                                <div class="card">
                                    ...
                                    <a class="btn btn-primary" href="excelformat/bulkVendorDelegate.xlsx" download>BULK SITES DELEGATE FORMAT</a>
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <label>Atmids</label>
                                                <input type="text" name="atmid" class="form-control" placeholder="Enter Atmids space seprated... like abcd efgh ijlk ">
