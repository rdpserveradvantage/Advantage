...
if($contactPersonName){
    ...
    $sql = "insert into projectCoordinator(contactPersonName,contactPersonNo,contactPersonEmail,status) values('".$contactPersonName."','".$contactPersonNo."','".$contactPersonEmail."',1)";
