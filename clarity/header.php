...
$token = $_SESSION['PROJECT_isProjectPortalToken'] ;
...
if(!$_SESSION['PROJECT_username'] || empty($_SESSION['PROJECT_username'])){
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        ...
                                        <span class="strong"><? echo ucwords($_SESSION['PROJECT_username']);?></span>
